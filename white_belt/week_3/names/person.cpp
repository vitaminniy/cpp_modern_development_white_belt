...
private:
  ...
  const std::string get_first_name(int year) {
    return find_by_year(year, first_names);
  }

  const std::string get_last_name(int year) {
    return find_by_year(year, last_names);
  }

  const std::string get_full_first_name(int year) {
    return history_name(year, first_names);
  }

  const std::string get_full_last_name(int year) {
    return history_name(year, last_names);
  }

  const std::string find_by_year(int year,
  ...
  const std::string history_name(int year,
                                 const std::map<int, std::string> &names) {
